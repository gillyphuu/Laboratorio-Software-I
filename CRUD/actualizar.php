    ...
    <body>
                <div class="container mt-6">
                    <form action="update.php" method="GET">
                                ...
                                <input type="hidden" name="cod_asignatura" value="<?php echo $row['cod_asignatura']  ?>">
                                
                                <input type="text" class="form-control mb-3" name="cod_asignatura" placeholder="Cod Asignatura" value="<?php echo $row['cod_asignatura']  ?>">
